...
(function (window, document) {
  ...
  function fireLongPressEvent (originalEvent) {
    ...
    const allowClickEvent = this.dispatchEvent(new CustomEvent('long-press', {
      bubbles: true,
      cancelable: true,
  ...
  function startLongPressTimer (e) {
    ...
    const longPressDelayInMs = parseInt(getNearestAttribute(el, 'data-long-press-delay', '1500'), 10) // default 1500
