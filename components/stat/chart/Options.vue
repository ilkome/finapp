...
.flex-center
  .cursor-pointer.w-10.py-2.px-3.flex-center.rounded-md.hocus_bg-item-main-hover(
    :class="{ 'text-item-base-up': chartState.show.income }"
    @click="toggleChart('income')"
  ): .mdi.mdi-arrow-down-thin-circle-outline

  .cursor-pointer.w-10.py-2.px-3.flex-center.rounded-md.hocus_bg-item-main-hover(
    :class="{ 'text-item-base-up': chartState.show.expense }"
    @click="toggleChart('expense')"
  ):  .mdi.mdi-arrow-up-thin-circle-outline

  .cursor-pointer.w-10.py-2.px-3.flex-center.rounded-md.hocus_bg-item-main-hover(
    :class="{ 'text-item-base-up': chartState.show.sum }"
  ...
  .cursor-pointer.w-10.py-2.px-3.flex-center.rounded-md.hocus_bg-item-main-hover(
    :class="{ 'text-item-base-up': isShowDataLabels }"
