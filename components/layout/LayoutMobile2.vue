...
export default {
  ...
  data () {
    return {
      ...
      periods: [{
        slug: 'day',
        name: this.$lang.dates.day.simple
      }, {
        slug: 'week',
        name: this.$lang.dates.week.simple
      }, {
        slug: 'month',
        name: this.$lang.dates.month.simple
      }, {
        slug: 'year',
        name: this.$lang.dates.year.simple
      }]
    }
  },
...
.wrap
  .layoutMobile
    ...
    .layoutMobile__menu
      LayoutMobileMenu2(:slider="slider")
