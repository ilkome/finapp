  ...
  <div>
    ...
    <div v-if="!isShowDates">
      ...
      <div
        ...
        class="border-item-3 border-b pb-2 pr-3"
      >
        <Amount
    ...
    >
      ...
      >
        <div
          :class="{ 'border-item-3': isShowGroupSum && groupTrnsIds.length > 1 }"
    ...
    >
      <div
        class="flex-center bg-item-hover text-2 hocus:bg-item-6 rounded-full px-5 py-2 text-sm"
