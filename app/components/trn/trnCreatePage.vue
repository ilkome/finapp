  ...
  .table
    .table__cell
      .panel.formPanel
        ...
        .meta
          .metaItem._left(@click.prevent.stop="showHideAllCategories()")
            .metaItem__el
              .icon(
...
export default {
  ...
  mounted() {
    this.rootEl.addEventListener('click', this.s())
  },

  beforeDestroy() {
    this.rootEl.removeEventListener('click', this.s())
  },
