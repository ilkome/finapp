...
<template>
  <div class="grid gap-6">
    ...
    <UiFormElement>
      ...
      <input
        :value="activeColor"
        class="border-item-5 focus:text-item-1 focus:bg-item-5 focus:border-accent-4 h-12 w-full rounded-lg border border-solid p-0 transition ease-in-out focus:outline-none"
        type="color"
