...
<template>
  ...
  >
    ...
    <template #content>
      <div class="grid gap-2 overflow-y-auto p-2 pt-6" style="max-height: var(--reka-popper-available-height, 80dvh)">
        <!-- Global grouping -->
        <div class="grid gap-1 px-1 pb-2">
