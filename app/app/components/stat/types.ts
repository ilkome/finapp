...
export const statConfigPanelIds = ['navigation', 'summary', 'wallets', 'statAverage', 'chart', 'catsRound', 'catsList', 'vertical', 'trns', 'categoryChildren', 'walletBalance', 'walletDescription', 'walletLoan'] as const
