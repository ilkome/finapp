...
import { buildTrnsBulkEdit, buildTrnsBulkEdits } from '~/components/trns/bulkEdits'
...
function build(items: Trns, action: Parameters<typeof buildTrnsBulkEdit>[0]['action']) {
  return buildTrnsBulkEdit({
    action,
