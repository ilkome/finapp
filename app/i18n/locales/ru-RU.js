export default {
  ...
  budgets: {
    ...
    title: 'Бюджеты',
    toAssign: { balance: 'Свести к нулю', fix: 'Исправить', over: 'Распределено сверх дохода', text: 'Уменьшайте распределение, пока остаток не станет нулевым. Освобождённые деньги можно распределить заново.', title: 'Уменьшить распределение' },
    triad: {
