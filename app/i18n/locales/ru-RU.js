export default {
  ...
  loans: {
    add: 'Добавить кредит',
    bankDebt: {
      off: 'Расхождение с долгом в банке',
      reconciled: 'Сверено с банком',
    },
    by: 'до',
    closed: 'Закрыт',
    contractRate: 'Ставка по договору',
    cost: 'Стоимость кредита',
    delete: 'Удалить кредит',
    deltaVsPlan: 'Отклонение от плана',
    dueThisMonth: 'К оплате в ближайший месяц',
    edit: 'Изменить кредит',
    editRow: 'Правка платежа',
    effectiveRate: 'Эффективная ставка',
    effectiveRateHint: '~{rate}% годовых по факту',
    errors: {
      deleteFailed: 'Не удалось удалить кредит',
      saveFailed: 'Не удалось сохранить кредит',
    },
    ...
    form: {
      ...
      overpaymentMode: 'Режим досрочного погашения',
      paymentDay: 'День платежа',
      prepayWindowDays: 'Досрочка, если раньше срока больше чем на, дней',
    ...
    interest: 'Проценты',
    interestMethods: {
      daily: 'По дням (факт/365)',
      monthly: 'Помесячно (ставка / 12)',
    },
    interestMissing: {
      hint: 'Вся сумма считается погашением долга. Добавьте проценты к каждому платежу, чтобы увидеть реальную ставку и долг.',
      summary: '{n} платежей без процентов | {n} платёж без процентов | {n} платежа без процентов | {n} платежей без процентов',
    },
    ...
    noDebitWallet: 'Не выбран',
    notEnoughOnDebit: 'Не хватает на счёте списания',
    ofPrincipal: '{share} от суммы кредита',
    overdue: 'Просрочено',
    overpaid: 'Переплата',
    page: {
      title: 'Кредиты',
    },
    paidInterest: 'Проценты',
    paidTotal: 'Уплачено',
    pay: 'Оплатить',
    plannedInterest: 'Плановые проценты',
    plannedOverpayment: 'Плановая переплата',
    portfolio: {
      empty: 'Кредитов пока нет',
      interestShare: 'Доля процентов',
      remaining: 'Остаток долга',
      title: 'Все кредитные продукты',
    },
    principal: 'Тело',
    principalFree: {
      holiday: 'Кредитные каникулы',
      interestOnly: 'Только проценты',
      summary: '{n} месяцев без погашения долга, уплачено процентов | {n} месяц без погашения долга, уплачено процентов | {n} месяца без погашения долга, уплачено процентов | {n} месяцев без погашения долга, уплачено процентов',
    },
    recommendation: {
      avalanche: 'Больше всего экономии',
      avalancheHint: 'Гасите его первым: он съедает больше всего процентов.',
      empty: 'Досрочно гасить нечего',
      freeMoney: 'Свободные деньги',
      snowball: 'Закроется быстрее всех',
      snowballHint: 'Самый маленький долг, закрывается первым для мотивации.',
      title: 'Куда направить свободные деньги',
    },
    resetRow: 'Вернуть к расчёту',
    revolving: {
      title: 'Кредитные карты и рассрочки',
    },
    schedule: 'График',
    scheduleTypes: {
      annuity: 'Аннуитетный',
    ...
    showLess: 'Свернуть',
    title: 'Кредит',
    unrecognized: 'Не сверено',
    unrecognizedHint: 'Баланс кошелька не сходится со сверенным телом. Проверьте импорт.',
    whatIf: 'Если внести сейчас',
  },
  locale: {
    en: 'Английский',
    ru: 'Русский',
  ...
  trnForm: {
    ...
    loanOfWhichInterest: 'Из них проценты',
