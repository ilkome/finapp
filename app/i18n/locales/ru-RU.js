export default {
  ...
  base: {
    ...
    filterAmountIn: 'Сумма в {currency}',
    ...
    toggleFolders: 'Свернуть / развернуть',
  ...
  sync: {
    ...
    errors: {
      pendingDiscarded: 'Несинхронизированные изменения предыдущего аккаунта ({count}) были удалены',
      sessionLostPending: 'Сессия завершилась, а {count} изменений ещё не синхронизированы. Войдите снова, чтобы отправить их.',
      signOutPending: 'Ещё не синхронизировано изменений: {count}. Подключитесь к интернету и попробуйте снова.',
