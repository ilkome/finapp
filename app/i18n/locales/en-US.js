export default {
  ...
  loans: {
    add: 'Add loan',
    bankDebt: {
      off: 'Off the bank debt',
      reconciled: 'Reconciled with the bank',
    },
    by: 'by',
    closed: 'Closed',
    ...
    dueThisMonth: 'Due within a month',
    edit: 'Edit loan',
    editRow: 'Edit payment',
    effectiveRate: 'Effective rate',
    effectiveRateHint: '~{rate}% a year in fact',
    errors: {
    ...
    form: {
      ...
      overpaymentMode: 'Overpayment mode',
      paymentDay: 'Payment day',
      prepayWindowDays: 'Prepayment if paid earlier than, days before the due date',
    ...
    interest: 'Interest',
    interestMethods: {
      daily: 'By days (actual/365)',
      monthly: 'Monthly (rate / 12)',
    },
    interestMissing: {
      hint: 'Their whole amount counts as principal. Add the interest to each payment to see the real rate and debt.',
      summary: '{n} payments without interest | {n} payment without interest | {n} payments without interest',
    },
    ...
    noDebitWallet: 'Not set',
    notEnoughOnDebit: 'Not enough on the debit wallet',
    ofPrincipal: '{share} of principal',
    overdue: 'Overdue',
    overpaid: 'Overpaid',
    page: {
      title: 'Loans',
    ...
    paidTotal: 'Paid',
    pay: 'Pay',
    plannedInterest: 'Planned interest',
    plannedOverpayment: 'Planned overpayment',
    portfolio: {
      empty: 'No loans yet',
      interestShare: 'Share of interest',
      remaining: 'Debt left',
      title: 'All credit products',
    },
    principal: 'Principal',
    principalFree: {
      holiday: 'Payment holiday',
      interestOnly: 'Interest only',
      summary: '{n} months without principal, interest paid | {n} month without principal, interest paid | {n} months without principal, interest paid',
    },
    recommendation: {
      avalanche: 'Biggest saving',
      avalancheHint: 'Pay this one down first: it costs the most interest.',
      empty: 'Nothing to pay down early',
      freeMoney: 'Free money',
      snowball: 'Closes soonest',
    ...
    unrecognizedHint: 'The wallet balance does not match the reconciled principal. Check the import.',
    whatIf: 'If you pay extra now',
  },
  locale: {
    en: 'English',
    ru: 'Russian',
  ...
  trnForm: {
    ...
    loanOfWhichInterest: 'Of which interest',
