...
| Stat config | `app/app/components/stat/config/schema.ts` (`ConfigSchema`), `app/app/components/stat/views/schema.ts` (saved views and rules) |
| Date / query params | `app/app/components/stat/date/params.ts` (`statDateParamsSchema`, `queryParamsSchema`) |
