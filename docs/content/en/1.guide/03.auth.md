...
seo:
  title: Authentication
  description: Sign in to Finapp with Google or email and password to sync data across devices. Offline mode, demo without registration, and account management.
---
