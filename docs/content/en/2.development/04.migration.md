...
Finapp's backend was migrated from **Firebase Realtime Database** to **Supabase Postgres + PowerSync** (offline-first sync) with **Supabase Auth (Google sign-in)**. This page documents that migration and the script that imports a Firebase JSON export into Supabase.
