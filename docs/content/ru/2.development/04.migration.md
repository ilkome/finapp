...
Бэкенд Финапки был мигрирован с **Firebase Realtime Database** на **Supabase Postgres + PowerSync** (offline-first синхронизация) с **Supabase Auth (вход через Google)**. На этой странице описана и сама миграция, и скрипт, который импортирует Firebase-экспорт в Supabase.
